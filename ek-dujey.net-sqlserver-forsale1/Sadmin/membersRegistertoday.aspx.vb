...
Partial Class Sadmin_membersRegistertoday
    ...
    Private Sub PopulatePublishersGridView()
        ...
        Else
            label1.Text = "No Members Registered Today"
    ...
    Function makequery() As String
        ...
        makequery = " convert(varchar(10),profiledate,103)=convert(varchar(10),getdate(),103)"
