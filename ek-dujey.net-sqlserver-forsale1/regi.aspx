<%@ Page Language="VB" MasterPageFile="~/mainpage.master" AutoEventWireup="false" CodeFile="regi.aspx.vb" Inherits="regi" title="Register"  ValidateRequest="false"%>
...
<asp:Wizard ID="reg" runat="server" ActiveStepIndex="0" Width="50%" style="background-color: inactivecaptiontext" BackColor="#EFF3FB" BorderColor="#B5C7DE" BorderWidth="1px" Font-Names="Verdana" Font-Size="0.8em" NavigationStyle-HorizontalAlign="Left">
    <WizardSteps>
        <asp:WizardStep runat="server" Title="Login Details">
        <table class="splfordata" id="TABLE1">
        <tr>
        <td>Password
        ...
        First Name
        ...
        </td><td style="width: 158px"><asp:TextBox ID="txtfname" runat="server"></asp:TextBox></td>
        </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td style="width: 158px">
                    <asp:TextBox ID="txtbirthdate" runat="server" MaxLength="10"></asp:TextBox>
	...
	if (!document.layers)
        ...
        <% end if %>
            ...
            <tr>
                <td colspan="2">
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Termsand Conditions.aspx">Please Go Through Terms and Conditions Before Using this Website</asp:HyperLink>
                </td>
            </tr>            
        </table>
        </asp:WizardStep>
        <asp:WizardStep runat="server" Title="Physical Details">
        ...
        <asp:WizardStep runat="server" Title="Location Details">
            <table class="splfordata">
                <tr>
        ...
        <asp:WizardStep runat="server" Title="About me &amp; Partner">
            <table class="splfordata">
                <tr>
                    ...
                    <td style="height: 189px">
                        <textarea id="aboutme" maxlength="700" onkeydown="textCounter(this,this.form.descriptionleft,700);" runat="server" rows="10" cols="60" onkeyup="return ismaxlength(this)" style="overflow: hidden"></textarea>
                     
                        
                        Characters Left:
                    <INPUT style='BORDER-RIGHT: 0px; BORDER-TOP:0px;BORDER-LEFT:0px; BORDER-BOTTOM:0px;FONT-SIZE: 15px; COLOR: #000; FONT-FAMILY:Arial' maxLength="3" name="descriptionleft" readOnly size="3"  value="700"> 
                        </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td align="left" valign="top">                        
                       ...
                       Characters Left:
                    <INPUT style='BORDER-RIGHT: 0px; BORDER-TOP:0px;BORDER-LEFT:0px; BORDER-BOTTOM:0px;FONT-SIZE: 15px; COLOR: #000; FONT-FAMILY:Arial' maxLength="3" name="descriptionleft2" readOnly size="3"  value="500"> 
        ...
        <asp:WizardStep runat="server" Title="Diet Details">
            <table class="splfordata">
                <tr>
                    <td style="width: 100px">
                        Diet</td>
                ...
                <tr>
                    <td id="tdmessage" runat="server" colspan="2" style="height: 21px; color: red;">
                    </td>
                </tr>
                <tr>
                    <td id="tdgetpassword" runat="server" colspan="2" style="color: red; height: 21px"
                        visible="False">
                        <asp:Button ID="Button1" runat="server" Text="Send Me Password" />
                    </td>
                </tr>
            </table>
        </asp:WizardStep>
    ...
    <NavigationStyle BorderColor="White" ForeColor="#0000C0" HorizontalAlign="Left" />
