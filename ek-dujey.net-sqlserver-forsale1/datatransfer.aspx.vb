    ...
    Sub profileTransfer()
        Try
            ...
            While myreader.Read
                ...
                sqlcolumns = "insert into profile(pid,headline,fname,lname,bdate,purpose,gender,email,countryid,countryname,state,cityname,whoami,lookingfor,profiledate,LastVisited,lastupdated,banned,ipaddress,maritalstatus,mothertounge,height,annualincome,familydetails,profession,passw,htname,castename,eyesight,wt,complexion,caste,cityid,verifiedemail,religion,zipcode,ref1,approved,hid,isonlinenow,ethnic,starsign,haircolor,education,nature,smoke,Drink,diet,drugs,children,thoughtsofmarriage,political,visibletoall,ref2) values"
                sqlvalues = "(@pid,@headline,@fname,@lname,@bdate,@purpose,@gender,@email,@countryid,@countryname,@state,@cityname,@whoami,@lookingfor,@profiledate,@LastVisited,@lastupdated,@banned,@ipaddress,@maritalstatus,@mothertounge,@height,@annualincome,@familydetails,@profession,@passw,@htname,@castename,@eyesight,@wt,@complexion,@caste,@cityid,@verifiedemail,@religion,@zipcode,@ref1,@approved,@hid,@isonlinenow,@ethnic,@starsign,@haircolor,@education,@nature,@smoke,@Drink,@diet,@drugs,@children,@thoughtsofmarriage,@political,@visibletoall,@ref2)"
