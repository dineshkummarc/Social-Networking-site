...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table width="90%">
        ...
        <tr>
            <td>
                <table>
                    ...
                    <tr>
                        <td>
                            <asp:HyperLink ID="HyperLink8" runat="server" NavigateUrl="~/members/inviteafriend.aspx">Invite a Friend</asp:HyperLink></td>
                    </tr>
                </table>
            </td>
       ...
       <asp:TemplateField>
        ...
        <tr> 
        <td>
            <a href="runalert.aspx?alid=<%# Eval("searchno") %>">Run Alert</a><br />
