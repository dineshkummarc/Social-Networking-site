...
Partial Class members_editreg
    ...
    Sub loaddata()
        ...
        'End If
        Label1.Text = ""
        strsql = "select top 1 * from profile where pid='" & Session("pid") & "'"
    ...
    Protected Sub reg_FinishButtonClick(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.WizardNavigationEventArgs) Handles reg.FinishButtonClick
        ...
        Try
            ...
            s4 = "wt=@wt,complexion=@complexion,caste=@caste,religion=@relgion,zipcode=@zipcode,ethnic=@ethnic,"
            s5 = "countryname=@countryname,lastupdated=@lastupdated,approved=@approved,starsign=@starsign,haircolor=@haircolor,"
            ...
            cmd.Parameters.AddWithValue("@bdate", txtbirthdate.Text.ToString)
