<%@ Page Language="VB" MasterPageFile="~/mainpage.master" AutoEventWireup="false" CodeFile="regi.aspx.vb" Inherits="regi" title="Register" %>
        ...
        <% end if %>
            ...
            <tr>
                <td>
                    Mother Tounge</td>
                <td>
                    <asp:TextBox ID="txtmothertounge" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
